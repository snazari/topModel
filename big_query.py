...
class RepositoryGhtorrentBq(object):
    ...
    def get_commit_comments(self):
        ...
        request(self.client, query, self.timeout, "commit_comments.csv")
    ...
    def get_pull_request_comments(self):
        ...
        request(self.client, query, self.timeout, 'pull_request_comments.csv')
...
if __name__ == '__main__':
    ...
    client = GitHubRepos()
    client.get_list_repository('Python')
    repository = RepositoryGitHubRepos('TheAlgorithms/Python')
    repository.contributors(100)
